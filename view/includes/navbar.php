...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li><a href="../controller/controller_form.php">New request</a></li>
  <li class="divider"></li>
</ul>
<nav class="light-blue">
  <div class="nav-wrapper">
    <a href="../controller/controller_home.php" class="brand-logo"> HelpMe Avocats</a>
    <ul class="right hide-on-med-and-down">
      <li><a href="../controller/controller_manage_algo.php">Manage Algorithm</a></li>
